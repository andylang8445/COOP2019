<?php
    ...
    print '<table id="myTable" border="2"><tr><th align="right"width="32"><button id="id_sec" onclick="sortTable1_1();">id &#62;</button></th><th align="right" id="name_sec" onclick="sortTable2();" width="64">name</th><th align="right" id="birthday_sec" onclick="sortTable3();" width="72">birthday</th><th align="right" id="age_sec" onclick="sortTable4();">age</th></tr>';
    for($i=0;$i<$tot;$i++){
        print "<tr>" ; 
