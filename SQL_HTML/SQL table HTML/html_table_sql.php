<?php
    ...
    print '<table id="myTable" border="2"><tr><th align="center" width="40"><button id="id_sec" onclick="sortTable1_1();"><strong>id &#62;</strong></button></th><th align="center" width="64"><button id="name_sec" onclick="sortTable2();"><strong>name</strong></button></th><th align="center" width="72"><button id="birthday_sec" onclick="sortTable3();"><strong>birthday</strong></button></th><th align="center" width="50"><button id="age_sec" onclick="sortTable4();"><strong>age</strong></button></th></tr>';
    for($i=0;$i<$tot;$i++){
        print "<tr>" ; 
