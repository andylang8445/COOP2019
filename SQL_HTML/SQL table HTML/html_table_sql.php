...
function toggle() {
    ...
    print '<table id="myTable" border="2"><tr><th style="text-align:center" id="id_sec" onclick="sortTable1();$previous=$sorted_element;toggle();$sorted_element=0;">id &#62;</th><th style="text-align:center" id="name_sec" onclick="sortTable2();$previous=$sorted_element;toggle();$sorted_element=1;">name</th><th style="text-align:center" id="birthday_sec" onclick="sortTable3();$previous=$sorted_element;toggle();$sorted_element=2;">birthday</th><th style="text-align:center" id="age_sec" onclick="sortTable4();$previous=$sorted_element;toggle();$sorted_element=3;">age</th></tr>';
    for($i=0;$i<$tot;$i++){
        print "<tr>" ; 
        print "<td style="text-align:center">" .$tot_result[$i][0]."</td>"; 
        print "<td style="text-align:center">" .$tot_result[$i][1]."</td>"; 
        print "<td style="text-align:center">" .$tot_result[$i][2]."</td>";
        print "<td style="text-align:center">" .$tot_result[$i][3]."</td>"; 
        print "</tr>" ; 
    } 
    /*if(count($_COOKIE)> 0) {
